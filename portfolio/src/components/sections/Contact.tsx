...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 px-6 md:px-[6%] bg-muted/30 text-center">
        ...
        {CONTACTS.map(({ Icon, label, href }) =>
          href ? (
            <motion.a
              ...
              whileHover={{ y: -4, boxShadow: "0 8px 25px rgba(124,58,237,0.3)" }}
              className="flex items-center gap-3 px-5 py-3 rounded-xl border border-border bg-card/50 backdrop-blur-sm hover:border-purple-400 transition-colors text-sm"
            >
            ...
            <div
              key={label}
              className="flex items-center gap-3 px-5 py-3 rounded-xl border border-border bg-card/50 backdrop-blur-sm text-sm"
            >
              <span className="text-purple-400"><Icon /></span>
              <span>{label}</span>
            </div>
      ...
      >
        ...
        <div>
          <input {...register("email")} placeholder="Your Email" className={inputCls} />
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-medium bg-gradient-to-r from-violet-600 to-purple-500 text-white shadow-lg shadow-violet-500/30 hover:opacity-90 transition-opacity disabled:opacity-60"
        >
      ...
      <div className="flex justify-center gap-3 flex-wrap">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-medium border border-violet-600 text-purple-400 hover:bg-violet-600 hover:text-white transition-colors"
        >
