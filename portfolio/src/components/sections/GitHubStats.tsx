...
export default function GitHubStats() {
  return (
    <SectionWrapper id="github" className="py-24 px-6 md:px-[8%]">
      ...
      <p className="text-center font-mono text-xs mb-12 tracking-widest" style={{ color: "var(--accent)", opacity: 0.6 }}>{"// live.signal"}</p>
      ...
      <div className="text-center">
        <a href={`https://github.com/${u}`} target="_blank" rel="noopener noreferrer" data-cursor="Open GitHub"
